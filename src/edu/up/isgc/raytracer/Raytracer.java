...
public class Raytracer {
    ...
    public static void main(String[] args) {
        ...
        scene01.setCamera(new Camera(new Vector3D(0, 0, -8), 160, 160, 800, 800, 0f, 20f));
        scene01.addLight(new PointLight(new Vector3D(0f,4f,-8f), new Color(255, 255, 255), 1.5));
        scene01.addObject(new Polygon(new Vector3D(0f, -2f, 5f), new Triangle[]{new Triangle(new Vector3D(10f,0f,10f), new Vector3D(-10f,0f,10f), new Vector3D(-10f,0f,-10f)),
                new Triangle(new Vector3D(-10f,0f,-10f), new Vector3D(10f,0f,-10f), new Vector3D(10f,0f,10f))}, Color.ORANGE, new Material(0.05,0.5,0.5,false,false)));
        scene01.addObject(OBJReader.GetPolygon("SmallTeapot.obj", new Vector3D(0f, -1.9f, -0.5f), new Color(255, 0, 0), new Material(0.5,1,0.5,false,false)));
        scene01.addObject(new Sphere(new Vector3D(-2f,0f, 0f), 0.6f, Color.PINK, new Material(0.8,0.5,0.5,false,true)));
        scene01.addObject(new Sphere(new Vector3D(2f,0f, 0f), 0.6f, Color.PINK, new Material(0.8,0.5,0.5,true,false)));

        BufferedImage image = raytrace(scene01);
        File outputImage = new File("Render.png");
        try {
